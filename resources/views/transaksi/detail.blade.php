                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="transaksi">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item">Status transaksi : {{ $dt->transaksi->status }}</li>
                                        <li class="list-group-item">Status pembayaran : {{ $dt->transaksi->status_pembayaran }}</li>
                                        <li class="list-group-item">Tanggal masuk : {{ $dt->transaksi->tgl }}</li>
                                        <li class="list-group-item">Estimasi : {{ $dt->transaksi->deadline }}</li>
                                        <li class="list-group-item">Nama member : {{ $dt->transaksi->member->nama }}</li>
                                        ...
                                        <li class="list-group-item">Biaya tambahan : {{ $dt->transaksi->biaya_tambahan }}</li>
                                        <li class="list-group-item font-weight-bold">Total akhir : {{ $dt->transaksi->total }}</li>
                                        <li class="list-group-item "><h1 class="text-success text-center"><b><u>{{ $dt->transaksi->kode_invoice }}</u></b></li></h1>
                                    </ul>
                                </div>
                                ...
                                <div class="tab-pane" id="member">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item">Alamat : {{ $dt->transaksi->member->alamat }}</li>
                                        <li class="list-group-item">Jenis Kelamin : {{ $dt->transaksi->member->jenis_kelamin }}</li>
                                        <li class="list-group-item">Telepon : {{ $dt->transaksi->member->telepon }}</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
