                        ...
                        <tbody>
                            @foreach ($detail_transaksi as $dt)
                                <tr>
                                    ...
                                    <td>
                                        <button type="submit" class="btn btn-outline-success  border-0" data-toggle="modal" data-target="#DetailModal{{ $dt->id_transaksi }}">
                                            Detail
                                        </button>
                                        <button type="submit" class="btn btn-outline-primary  border-0" data-toggle="modal" data-target="#Faktur{{ $dt->id_transaksi }}">
                                            Faktur
                                        </button>
                                    </td>
                                </tr>
