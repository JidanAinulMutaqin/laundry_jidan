...
<!-- Modal Edit -->
<div class="modal fade" id="edituserModal{{ $u->id }}" tabindex="-1" aria-labelledby="editmemberModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/{{ request()->segment(1)}}/user/{{ $u->id }}" method="POST" class="text-dark">
                @method('PUT')
             @csrf
             <div class="mb-3">
              ...
              <div class="mb-3">
                  <label for="id_outlet" class="form-label">Outlet</label>
                    <select class="form-select form-select mb-3" aria-label=".form-select example" id="outlet" name="id_outlet" required autofocus value="{{ old('id_outlet', $u->id_outlet) }}">
              ...
              <div class="mb-3">
                  ...
                  <select class="form-select form-select mb-3" aria-label=".form-select example" id="role" name="role" required autofocus value="{{ old('role', $u->role) }}">
