...
class PenggunaanBarangExport implements FromCollection, WithHeadings, WithEvents, WithMapping
{
    ...
    */
    ...
    public function map($penggunaan_barang): array
    {
        return[
            $penggunaan_barang->id,
            $penggunaan_barang->nama_barang,
            $penggunaan_barang->qty,
            $penggunaan_barang->harga,
            $penggunaan_barang->waktu_beli,
            $penggunaan_barang->supplier,
            $penggunaan_barang->status
        ];
    }
